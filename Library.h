...
class Library {
    ...
    public:
        ...
        */
        ...
        /*
         * Linear Algorithm to find the index of a given target.
         * Iterates though the whole array having a complexity of O<img class="icon emoticon" alt="No" title="No" src="https://online.upr.edu/theme/image.php/fordson/core/1650468304/s/no" /> in the worst case scenario
         *
